...
run: data data/agg.txt
		mpicc -fopenmp ./src/data_structures/dense_matrix.c ./src/data_structures/sparse_matrix.c ./src/data_structures/ipfp_functions.c ./src/mpi_communications.c ./src/main.c
		mpirun -n $(N_PROC) ./a.out ./data/agg.txt ./data/poi.txt ./data/cbg.txt ./data  $(N_THREADS) $(N_HOURS)


# to run this script you need the dataset 
run_real: data/aggregate_visit_matrix.txt
		mpicc -fopenmp ./src/data_structures/dense_matrix.c ./src/data_structures/sparse_matrix.c ./src/data_structures/ipfp_functions.c ./src/mpi_communications.c ./src/main.c
		mpirun -n $(N_PROC) ./a.out ./data/aggregate_visit_matrix.txt ./data/poi_marginals_2020_03_02.txt ./data/cbg_marginals_2020_03_02.txt ./data $(N_THREADS) $(N_HOURS)
